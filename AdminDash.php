...
<html>
    ...
    /* ==== Color ==== */
    --body-color:  #ffd6f8;
    --sidebar-color: #ee7ebc;
    --container-color: #FFE9FB;
    --logotext-color: #534134;
    --toggle-color: #f7f7f7;
    --text-color: #6f1f5e;
    --hover-color: #a53492;
    --card-color:#fbc1e6;
  ...
  #navbarMenu a.active, #navbarMenu a:hover {
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light fixed-position">
            <a href="#" class="navbar-brand">
                <img src="" alt="">
                <button class="navbat-toggler" type="button" data-toggle="collapse">
                    <span class="navbar-toggler-icon"></span>
                </button>

                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav pe-2 ml-auto text-right" href="#">
                        <li class="nav-item">
                            <a href="#" class="nav-link active">Dashoard</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link mb-2 fs-6" onclick="">Applications</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link mb-2 fs-3" onclick="">Products</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link mb-2 fs-3" onclick="">Contact</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link mb-2 fs-6"></a>
                        </li>
                    </ul>
                </div>
            </a>
