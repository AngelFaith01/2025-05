...
if (isset($_POST['signup'])) {
    ...
    $checkSql = "SELECT * FROM `admin` WHERE `user` = ? OR `email` = ?";
    ...
    if ($stmt = $conn->prepare($sql)) { 
        ...
        if ($result->num_rows > 0) { 
            ...
            if (password_verify($password, $row['password'])) {  
                ...
                header("Location: admn.php"); // Redirect to admin page
                exit(); 
            } else {  
...
<head>
    ...
    <title>Login</title><meta name="viewport" content="width = device-width, initial-scale = 1, shrink-to-fit = no">
        ...
        <div class="container__form container--signup">
            <form action="login.php" class="form" id="form1" method="POST">
                ...
                <div class="form-group" style="margin-top: .3rem;">
                    <input type="text" class="form-control border rounded" placeholder="Username" name="user" required />
                </div>
                <div class="form-group" style="margin-top: .3rem;">
                    <input type="email" class="form-control border rounded" placeholder="Email" name="email" required />
                </div>
                <div class="form-group" style="margin-top: .3rem;">
                    <input type="password" class="form-control border rounded" placeholder="Password" name="password" required />
                </div>
                <button type="submit" class="btn btn-outline-secondary btn-sm" name="signup">Sign Up</button>
            </form>
        </div>

        <!-- Sign In -->
        <div class="container__form container--signin">
            <!--<form action="login.php" class="form" id="form2" method="POST"></form>-->
            <form id="form2" method="POST">
                ...
                <div class="form-group" style="margin-top: .3rem;">
                 ...
                 <button type="submit" class="btn btn-outline-secondary btn-sm" name="signin">Sign In</button> 
            </form>
        </div>
