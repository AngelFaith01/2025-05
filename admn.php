...
<section class="container my-5" style="font-family: 'Poppins', sans-serif;" id="applicants">
  <div class="card" style="padding: 1rem; border: #1c3347 .5px solid; box-shadow: 7px 2px 12px 2px #1c3347; height: 450px; overflow-y: auto; border-radius: 15px;">
    ...
    <div class="row justify-content-between align-items-center mb-3" style="font-family: 'Poppins', Sans serif; margin-top: .5rem;">
      ...
      <div class="col-md-8 col-12">
        <form action="" method="GET">
          ...
          <!-- click the checkbox before searching -->
    ...
    <div class="table-responsive" style="font-family: 'Poppins', Sans serif; box-shadow: 7px 2px 12px 2px #aaa;">
      <table class="table">
        <thead>
          <tr>  
            <th style="text-align: center; border: #1c3347 0.5px solid; border-top-left-radius: 10px;">Job Title</th>
            <th style="text-align: center; border: #1c3347 0.5px solid;">Name</th>
            <th style="text-align: center; border: #1c3347 0.5px solid;">Email</th> 
            <th style="text-align: cenetr; border: #1c3347 .5px solid;">File</th>
            <th style="text-align: center; border: #1c3347 0.5px solid; border-top-right-radius: 10px;">Mail</th>
          </tr>
        </thead>
        ...
        if (isset($_SESSION['admin_id'])) {
            ...
            $query = "SELECT *  FROM applicant AS A  INNER JOIN joboffer AS B ON A.job_id = B.job_id WHERE 1"; 
        ...
        ?>
          <tr> 
            <td style="text-align: center; border: #1c3347 .5px solid;"><?= htmlspecialchars($row["job_title"]) ?></td> 
            <td style="text-align: center; border: #1c3347 .5px solid;"><?= htmlspecialchars($row['firstname']) . ' ' . htmlspecialchars($row['lastname']) ?></td>
            <td style="text-align: center; border: #1c3347 .5px solid;"><?= htmlspecialchars($row['email']) ?></td> 
            <td style="text-align: center; border: #1c3347 .5px solid;"><?= $filepath ?></td>
            <td style="text-align: center; border: #1c3347 .5px solid;">
              <a href="#MailModal" 
        ...
        <tr>
            ...
            <td style="text-align: center; border: #1c3347 .5px solid;">
                <a href="#MailModal" 
                  class="open-mail-modal btn btn-outline-secondary btn-sm text-dark bg-light" 
                  data-id="<?= $row['id'] ?>" 
                  style="border: #1c3347 .5px solid; border-radius: 15px; box-shadow: 5px 0px 10px 0px #1c3347;">
                  Send Mail
                </a>
            </td>
        </tr>
...
<div class="modal-dialog" id="MailModal" style="font-family: 'Poppins', Sans serif; display: flex; justify-content: center; align-items: center; position: fixed; top: 30%; left: 50%; transform: translate(-50%, -50%); z-index: 1050; ">
  <div style="box-shadow: 5px 0px 10px 0px #1c3347; border: #1c3347 .5px solid; ">
    ...
    <div class="form-group">
      <!-- <form action="send_mail.php" method="POST">
       ...
       <form action="send_mail.php" method="POST">
  <input type="hidden" name="id" id="modal-applicant-id"> 
